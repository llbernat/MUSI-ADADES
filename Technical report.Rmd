...
Después de un análisis más profundo vemos que el dato que falta corresponde a la tarde del domingo del 07-06-2020. Creamos ese valor y le damos el mismo valor de VA que la tarde del día anterior (que es sábado). Usamos ahora el *dataset* corregido
